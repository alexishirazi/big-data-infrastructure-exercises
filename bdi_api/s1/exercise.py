...
def get_aircraft_statistics(icao: str) -> dict:
    ...
    # Handle 'ground' values in altitude_baro column
    # Replace 'ground' with 0 for altitude calculations
    df["altitude_baro"] = pd.to_numeric(df["altitude_baro"].replace("ground", "0"), errors="coerce")
    ...
    had_emergency = bool(df["emergency"].any()) if "emergency" in df.columns else False
